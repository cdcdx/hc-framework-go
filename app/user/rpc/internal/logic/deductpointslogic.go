...
func (l *DeductPointsLogic) DeductPoints(in *user.DeductPointsRequest) (*user.DeductPointsResponse, error) {
	if in.Points <= 0 {
	...
	return &user.DeductPointsResponse{PointsBalance: balance}, nil
}
